...
<body>
    ...
    <main class="container">
        ...
        <header class="form-header">
            ...
            <h1 class="form-title">✏️ Sửa Booking</h1>

            <p class="form-subtitle">Chỉnh sửa thông tin booking tour du lịch (Khách lẻ / Đoàn)</p>
        ...
        <form action="<?= BASE_URL_ADMIN . '?act=edit-booking' ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="loaiKhach" class="form-select" name="LoaiKhach" required>
                            <option value="1" <?= (isset($detailBooking['LoaiKhach']) && $detailBooking['LoaiKhach'] == 1) ? 'selected' : '' ?>>
                                👤 Khách lẻ
                            </option>
                            <option value="2" <?= (isset($detailBooking['LoaiKhach']) && $detailBooking['LoaiKhach'] == 2) ? 'selected' : '' ?>>
                                👥 Khách đoàn
                            </option>
                        </select>
            ...
            <section class="form-section">
                ...
                <div class="form-group">
                    ...
                    <select id="tourName" class="form-select" name="TourID">
            ...
            <button type="submit" class="submit-button"> 💾 Cập Nhật Booking </button>

            <a href="<?= BASE_URL_ADMIN . "?act=list-booking" ?>" class="back-button" style="width: 100%; text-align: center;">↩️ Quay lại danh sách</a>
    ...
    <script>
        // Demo: tự động kiểm tra chỗ trống (giữ lại logic từ layout cũ)
