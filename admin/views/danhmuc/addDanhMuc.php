    ...
    <div class="form-container">
     <form action="<?= BASE_URL_ADMIN . '?act=them-danh-muc' ?>" method="POST">
      <div class="form-group">
       ...
       <input type="text" id="category-name" name="ten_danh_muc" placeholder="Nhập tên danh mục (VD: Tour Miền Bắc)" required>
      ...
      <div class="form-group">
       ...
       <textarea id="category-description" name="mo_ta" rows="6" placeholder="Nhập mô tả chi tiết về danh mục này..."></textarea>
      </div>
