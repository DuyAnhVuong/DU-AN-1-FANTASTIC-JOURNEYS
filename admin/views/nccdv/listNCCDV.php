...
<body>
  <div class="container">
    <div class="admin-panel">
      <header class="header">
        <h1 id="page-title">Quản Trị Nhà Cung Cấp Dịch Vụ</h1>
        <p>Quản lý và tổ chức các dịch vụ tour một cách hiệu quả</p>
      </header>
      <div class="toolbar">
        <div class="search-box"><input type="text" placeholder="Tìm kiếm nhà cung cấp dịch vụ...">
        </div>
        <a href="<?= BASE_URL_ADMIN . '?act=form-them-ncc-dv' ?>" style="text-decoration: none;">
          <button class="btn-primary" id="add-button">
            <svg width="20" height="20" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <line x1="12" y1="5" x2="12" y2="19"></line>
              <line x1="5" y1="12" x2="19" y2="12"></line>
            </svg><span id="add-button-text">Thêm Nhà Cung Cấp Dịch Vụ Mới</span>
          </button>
        </a>
      </div>
          ...
          <tbody>
            <?php foreach ($ncc_dv as $key => $dv): ?>
              <tr>
                ...
                <td>
                  <div class="actions">
                    <a href="<?= BASE_URL_ADMIN . '?act=form-sua-ncc-dv&id_dichvu=' . $dv['id_dichvu'] ?>">
                      <button class="btn-edit">Sửa</button>
                    </a>
                    <a href="<?= BASE_URL_ADMIN . '?act=xoa-ncc-dv&id_dichvu=' . $dv['id_dichvu'] ?>"
