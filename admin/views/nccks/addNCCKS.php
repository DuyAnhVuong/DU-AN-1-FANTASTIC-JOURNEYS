...
<html lang="vi">
 ...
 <body>
  <div class="container"><div class="admin-panel" id="create-form">
    <header class="header">
     <h1 id="form-title">Tạo Nhà Cung Cấp Khách Sạn Mới</h1>
     <p>Nhập thông tin chi tiết để tạo nhà cung cấp khách sạn mới</p>
    </header>
    <div class="form-container">
     <form action="<?= BASE_URL_ADMIN . '?act=them-ncc-ks' ?>" method="POST">
      <div class="form-group">
       <label for="category-name">Tên Nhà Cung Cấp Khách Sạn <span class="required">*</span></label>
       <input type="text" id="category-name" name="NameKS" required>
      ...
      <div class="form-actions">
       ...
       <button type="submit" class="btn-primary">
        ...
        </svg><span id="submit-button-text">Tạo Nhà Cung Cấp Khách Sạn</span> 
       </button>
      </div>
     </form>
    </div>
