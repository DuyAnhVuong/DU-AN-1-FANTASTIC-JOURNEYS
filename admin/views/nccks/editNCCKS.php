...
<html lang="vi">
 ...
 <body>
  <div class="container"><div class="admin-panel" id="edit-form">
    <header class="header">
     <h1 id="edit-form-title">Sửa Nhà Cung Cấp Khách Sạn</h1>
     <p>Cập nhật thông tin nhà cung cấp Khách Sạn</p>
    </header>
    <div class="form-container">
     <form action="<?=BASE_URL_ADMIN .'?act=sua-ncc-ks' ?>" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="id_ks" value="<?= $ncc_ks['id_ks']?>">

      <div class="form-group">
       <label for="edit-category-name">Tên Nhà Cung Cấp Khách Sạn <span class="required">*</span></label>
       <input type="text" id="edit-category-name" name="NameKS" 
              value="<?= $ncc_ks['NameKS']?>" 
              placeholder="Nhập tên nhà cung cấp Khách Sạn" required>
       <?php if(isset($errors['NameKS'])) { ?>
        <span class="form-help"><?= $errors['NameKS'] ?></span>
       <?php }?>
      </div>
      <div class="form-actions">
       <a href="<?= BASE_URL_ADMIN . '?act=list-ncc-ks' ?>" style="text-decoration: none;">
