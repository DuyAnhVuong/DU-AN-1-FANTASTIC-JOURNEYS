...
<html lang="vi">
 ...
 <body>
  <div class="container"><div class="admin-panel" id="create-form">
    <header class="header">
     <h1 id="form-title">Tạo Nhà Cung Cấp Phương Tiện Mới</h1>
     <p>Nhập thông tin chi tiết để tạo nhà cung cấp phương tiện mới</p>
    </header>
    <div class="form-container">
     <form action="<?= BASE_URL_ADMIN . '?act=them-ncc-pt' ?>" method="POST">
      <div class="form-group">
       <label for="category-name">Tên Nhà Cung Cấp Phương Tiện <span class="required">*</span></label>
       <input type="text" id="category-name" name="Name_PhuongTien" required>
      ...
      <div class="form-actions">
       ...
       <button type="submit" class="btn-primary">
        ...
        </svg><span id="submit-button-text">Tạo Nhà Cung Cấp Phương Tiện</span> 
       </button>
      </div>
     </form>
    </div>
