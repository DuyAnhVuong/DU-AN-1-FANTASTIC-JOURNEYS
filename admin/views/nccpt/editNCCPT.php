...
<html lang="vi">
 ...
 <body>
  <div class="container"><div class="admin-panel" id="edit-form">
    <header class="header">
     <h1 id="edit-form-title">Sửa Nhà Cung Cấp Phương Tiện</h1>
     <p>Cập nhật thông tin nhà cung cấp phương tiện</p>
    </header>
    <div class="form-container">
     <form action="<?=BASE_URL_ADMIN .'?act=sua-ncc-pt' ?>" method="POST" enctype="multipart/form-data">
      <input type="hidden" name="id_pt" value="<?= $ncc_pt['id_pt']?>">

      <div class="form-group">
       <label for="edit-category-name">Tên Nhà Cung Cấp Phương Tiện <span class="required">*</span></label>
       <input type="text" id="edit-category-name" name="Name_PhuongTien" 
              value="<?= $ncc_pt['Name_PhuongTien']?>" 
              placeholder="Nhập tên nhà cung cấp phương tiện" required>
       <?php if(isset($errors['Name_PhuongTien'])) { ?>
        <span class="form-help"><?= $errors['Name_PhuongTien'] ?></span>
       <?php }?>
      </div>
      <div class="form-actions">
       <a href="<?= BASE_URL_ADMIN . '?act=list-ncc-pt' ?>" style="text-decoration: none;">
  ...
  <script>
    const defaultConfig = {
      edit_form_title: "Sửa Nhà Cung Cấp Phương Tiện",
      update_button_text: "Cập Nhật Nhà Cung Cấp Phương Tiện"
    };
