...
<style>
  ...
  * {
  ...
  thead th:nth-child(4) {
    min-width: 100px; /* Đã điều chỉnh thành min-width để linh hoạt hơn */
    width: auto; 
  }
  ...
  .category-type {
   ...
   font-size: 12px;
   font-weight: 600;
      white-space: nowrap; /* Đã thêm để ngăn xuống dòng */
  }
  ...
  <div class="container">
   <div class="admin-panel">
      ...
      <tbody>
       ...
       ?>
        <tr>
         ...
         <td>
          <div class="actions">
           <a href="<?= BASE_URL_ADMIN . '?act=chi-tiet-lich-trinh&id=' . $tourr['TourID'] ?>" class="btn-detail">
             <svg width="14" height="14" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path> <circle cx="12" cy="12" r="3"></circle></svg> Chi tiết 
           </a>
           <a href="<?= BASE_URL_ADMIN . '?act=form-sua-tour&id=' . $tourr['TourID'] ?>" class="btn-edit">
             <svg width="14" height="14" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path> <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Sửa 
           </a>
    ...
    <div class="pagination">
     ...
     <div class="pagination-controls"><button class="page-btn">❮ Trước</button> <button class="page-btn active">1</button> <button class="page-btn">2</button> <button class="page-btn">3</button> <button class="page-btn">Sau ❯</button>
     </div>
    </div>
   </div>
  </div>
