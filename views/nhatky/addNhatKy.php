...
<html lang="vi">
 <head>
  ...
  <title>Quản Trị Nhật ký Tour Du Lịch</title>
 ...
 <body>
  <div class="container"><div class="admin-panel" id="create-form">
    <header class="header">
     <h1 id="form-title">Tạo Nhật Ký Mới</h1>
     <p>Nhập thông tin chi tiết để tạo nhật ký tour du lịch mới</p>
    </header>
    <div class="form-container">
     <form action="<?= BASE_URL . '?act=them-nhat-ky' ?>" method="POST">
      <div class="form-group">
       <label for="category-name">Những thứ cần ghi <span class="required">*</span></label>
       <input type="text" id="category-name" name="mo_ta" placeholder="Nhập... " required>
       <?php if (isset($errors['mo_ta'])) { ?>
        <span class="form-help"><?= $errors['mo_ta'] ?></span>
       <?php } ?>
      </div>
      <div class="form-group">
       <label for="category-description">Ngày</label>
       <input type="date"  name="ngay" placeholder="Nhập... " required>
      </div>
      <div class="form-actions">
        <a href="<?= BASE_URL . '?act=list-nhat-ky' ?>" style="text-decoration: none;">
       ...
       <button type="submit" class="btn-primary">
        ...
        </svg><span id="submit-button-text">Tạo nhật ký mới</span> 
       </button>
      </div>
     </form>
    </div>
