...
<html lang="vi">
 ...
 <body>
  <div class="container"><div class="admin-panel" id="edit-form">
    <header class="header">
     <h1 id="edit-form-title">Sửa nhật ký</h1>
     <p>Cập nhật thông tin nhật ký tour du lịch</p>
    </header>
    <div class="form-container">
     <form action="<?=BASE_URL .'?act=edit-nhat-ky' ?>" method="POST">
      <input type="hidden" name="id_nhat_ky" value="<?= $nhatky['id_nhat_ky']?>" > 
      
      <div class="form-group">
       <label for="edit-category-name">Mô tả<span class="required">*</span></label>
       <input type="text" id="edit-category-name" name="mo_ta" 
              value="<?= $nhatky['mo_ta']?>" 
      ...
      <div class="form-group">
       <label for="edit-category-description">Ngày</label>
       <input type="date" id="edit-category-name" name="ngay" 
              value="<?= $nhatky['ngay']?>" 
      ...
      <div class="form-actions">
       ...
       <button type="submit" class="btn-primary">
        ...
        </svg><span id="update-button-text">Cập Nhật Nhật Ký</span> 
       </button>
      </div>
     </form>
    </div>
