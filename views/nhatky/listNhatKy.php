...
<body>
  <div class="container">
    <div class="admin-panel">
      <header class="header">
        <h1 id="page-title">Quản Trị Nhật Ký Tour Du Lịch</h1>
        <p>Quản lý và tổ chức các danh mục tour một cách hiệu quả</p>
      </header>
      <div class="toolbar">
        <div class="search-box"><input type="text" placeholder="Tìm kiếm nhật ký...">
        </div>
        <a href="<?= BASE_URL . '?act=form-them-nhat-ky' ?>" style="text-decoration: none;">
          <button class="btn-primary" id="add-button">
            <svg width="20" height="20" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <line x1="12" y1="5" x2="12" y2="19"></line>
              <line x1="5" y1="12" x2="19" y2="12"></line>
            </svg><span id="add-button-text">Thêm Nhật Ký Mới</span>
          </button>
        </a>
      </div>
      <div class="table-container">
        <table>
          ...
          <tbody>
            <?php foreach ($listNhatKy as $key => $nhatky): ?>
              <tr>
                <td><?= $key + 1 ?></td>
                <td>
                ...
                <td>
                  <div class="actions">
                    <a href="<?= BASE_URL . '?act=form-edit-nhat-ky&id_nhat_ky=' . $nhatky['id_nhat_ky'] ?>">
                      <button class="btn-edit">Sửa</button>
                    </a>
                    <a href="<?= BASE_URL . '?act=xoa-nhat-ky&id_nhat_ky=' . $nhatky['id_nhat_ky'] ?>"
      ...
      <a href="<?= BASE_URL ?>" style="text-decoration: none; margin: 20px;">
